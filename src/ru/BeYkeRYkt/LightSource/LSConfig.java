...
public class LSConfig {
	...
	public enum UpdateMode {
		/**
		 * player light : true entity light: false item light: false Task delay: 15 max-iterations-per-tick: 5 ignore-save-update-light: false
		 */
		SAVE,

		/**
		 * player light : true entity light: true item light: true Task delay: 5 max-iterations-per-tick: 15 ignore-save-update-light: true
		 */
		MAXIMUM,

		/**
		 * player light : true entity light: false item light: false Task delay: 10 max-iterations-per-tick: 10 ignore-save-update-light: false
		 */
		USER;
	}
